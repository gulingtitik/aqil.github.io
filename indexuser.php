<?php
session_start();
// Periksa apakah cookie 'nama_cookie' sudah ada dan belum kadaluarsa
if(isset($_COOKIE['nama']) && !empty($_COOKIE['nama'])) {
    // Cookie sudah ada dan belum kadaluarsa, lanjutkan dengan konten halaman
} else {
    // Jika cookie belum ada atau sudah kadaluarsa, arahkan ke halaman tujuan
        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="profil.php">profil</a>
                    </li>
                    <li class="nav-item"><a class="nav-link active" aria-current="page"
                            href="logoutproses.php">logout</a></li>
                    <li class="nav-item"><a class="nav-link" href="posting.php">posting</a></li>
                    <li class="nav-item"><a class="nav-link" href="makecomu.php">buat komunitas lo</a>
                    </li>
                    <li class="nav-item">
                        <form action="index_pencarian.php" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="search" aria-describedby="emailHelp"
                                    placeholder="cari komunitas lo disini" required />
                            </div>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                        <a class="btn btn-primary btn-lg px-4 me-sm-3" href="agenda.php">agenda</a>
                        <a class="btn btn-outline-light btn-lg px-4" href="regis_post.php">sign up</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container px-5 my-5">
            <div class="row gx-5">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <form action="index_pencarian.php" method="POST">
                        <button class="btn btn-primary btn-sm " type="submit" name="view[]"
                            value="<?php echo $row['id_komu'] ?>">
                            view</button>

                    </form>
                    <form action="proses_join.php" method="POST">
                        <button class="btn btn-primary btn-sm " type="submit" name="join[]"
                            value="<?php echo $row['id_komu'] ?>">
                            join</button>
                    </form>
                ...
                <div class=" col-lg-4 mb-5 mb-lg-0">
                    ...
                    <button>
                        <a href="hapusproses.php?id=<?php echo $row['id_post']; ?>">
                            hapus
                        </a>
                    </button>
                    <form action="coment.php" method="POST">
                        <button class="btn btn-primary btn-sm " type="submit" name="coment[]"
                            value="<?php echo $row['id_post'] ?>">
                            coment
                        </button>
                    </form>
                    <form action="save_proses.php" method="POST">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="card mb-5 mb-xl-0">
                    <div class="card-body p-5">
                        ...
                        <div class="d-grid"><a class="btn btn-primary" href="#!">Choose plan</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    <p class="mb-1">Thank you for putting together such a great product.
                                        We loved
                                        working with you and the whole team, and we will be recommending
                                        you to others!
                                    </p>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    <p class="mb-1">The whole team was a huge help with putting things
                                        together for our
                                        company and brand. We will be hiring them again in the near
                                        future for
                                        additional work!</p>
                                    <div class="small text-muted">- Client Name, Location</div>
                                </div>
